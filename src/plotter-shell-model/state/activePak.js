define(["require", "exports", "./viewInstance"], function (require, exports, viewInstance_1) {
    "use strict";
    var ActivePak = (function () {
        ...
        ActivePak.fromJSON = function (json) {
            ...
            activePak.viewInstances = json.viewInstances.map(function (viewInstanceJson) {
                var viewInstance = viewInstance_1.ViewInstance.fromJSON(viewInstanceJson);
...
//# sourceMappingURL=activePak.js.map